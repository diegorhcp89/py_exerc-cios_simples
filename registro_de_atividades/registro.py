# Projeto Prático: Registro do Atividades
# Descrição: Este programa permite que o usuário registre, visualize,
# busque e exclua atividades ou notes em um arquivo de texto.
...
def visualizar_atividades():
    try:
        ...
        print("Nenhuma atividade resistrada ainda.")
    ...
    try:
        with open(NOME_ARQUIVO, "r") as arquivo:
            ...
            if resultados:
                ...
                print(f"Nenhuma ativiadade encontrada para o termo: {termo}")
...
def excluir_atividade():
    ...
    try:
        ...
        if atividades:
            ...
            indice = int(input("Digite o número da ativiade que deseja excluir: "))
