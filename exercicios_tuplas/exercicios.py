...
tempo_lista = timeit.timeit(stmt="for x in lista: pass", setup="lista = list(range(1_000_000))", number=1)
tempo_tupla = timeit.timeit(stmt="for x in tupla: pass", setup="tupla = tuple(range(1_000_000))", number=1)
